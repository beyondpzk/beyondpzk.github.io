...
featured: true
summary: 从量化误差到 TensorRT 工程，整理视觉模型在 NVIDIA 平台上的精度、吞吐与显存取舍，连接算法选择和部署验证。
---
